...
Figure 1. A relationship between Employee and iteself in which one Employee is the Supervisor of another Employee. The single line between Employee and Supervises means that not every entity of Employee must participate in the relationship.
...
Figure 2. A relationship between Employee and Department in which an Employee works in a Department. The double line between Employee and Works For means that every entity of Employee participates in the relationship, and the the double line between Works For and Department means the same for Department.
...
Now that you have completed this tutorial you should have a good understanding of how participation constraints work, the different types, and how it raises performance in data integrity and accuracy.
